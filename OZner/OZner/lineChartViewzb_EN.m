...
#import "lineChartViewzb_EN.h"
#import "CupRecord.h"

@implementation lineChartViewzb_EN
...
- (void)weekGraphView
{
    ...
    MPGraphViewzb_EN* graph=[[MPGraphViewzb_EN alloc] initWithFrame: CGRectMake(14*(SCREEN_WIDTH/375.0),0, SCREEN_WIDTH-14*(SCREEN_WIDTH/375.0)*2, 150) timeType:1 cellType:self.CellType title1:self.title1 title2:self.title2 title3:self.title3];
...
- (void)monthGraphView
{
    ...
    MPGraphViewzb_EN* graph=[[MPGraphViewzb_EN alloc] initWithFrame: CGRectMake(14*(SCREEN_WIDTH/375.0),0, SCREEN_WIDTH-14*(SCREEN_WIDTH/375.0)*2, 150) timeType:2 cellType:self.CellType title1:self.title1 title2:self.title2 title3:self.title3];
    NSMutableArray* muArr = [[NSMutableArray alloc]init];
    //NSMutableArray* zongArr = [[NSMutableArray alloc]init];
