...
#import "WaterineChartView_EN.h"
#import "CupRecord.h"

@implementation WaterineChartView_EN
...
- (void)weekGraphView:(int)beforeOrAfter
{
    ...
    WaterMPGraphView_EN* graph=[[WaterMPGraphView_EN alloc] initWithFrame: CGRectMake(14*(SCREEN_WIDTH/375.0),0, SCREEN_WIDTH-14*(SCREEN_WIDTH/375.0)*2, 150) timeType:0 IsBadTds:beforeOrAfter];
...
- (void)monthGraphView:(int)beforeOrAfter
{
    ...
    WaterMPGraphView_EN* graph=[[WaterMPGraphView_EN alloc] initWithFrame: CGRectMake(14*(SCREEN_WIDTH/375.0),0, SCREEN_WIDTH-14*(SCREEN_WIDTH/375.0)*2, 150) timeType:1 IsBadTds:beforeOrAfter];
    NSMutableArray* muArr = [[NSMutableArray alloc]init];
    //NSMutableArray* zongArr = [[NSMutableArray alloc]init];
