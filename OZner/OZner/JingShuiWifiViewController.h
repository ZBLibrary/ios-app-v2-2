...
@protocol JinShuiqiWIFIControllerDelegate <NSObject>
...
@interface JingShuiWifiViewController : OCFatherViewController
{
    BOOL m_bIsAgree;
    BOOL m_bIsShow;
    NSTimer* mTimer;
...
@property (nonatomic,assign) id<JinShuiqiWIFIControllerDelegate>delegate;
