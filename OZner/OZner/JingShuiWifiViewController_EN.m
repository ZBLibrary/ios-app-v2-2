...
#import "JingShuiWifiViewController_EN.h"
#import "VersionSettingDBManager.h"
#import "MXChipPair.h"
#import "OZner-swift.h"
@interface JingShuiWifiViewController_EN ()<MxChipPairDelegate,UIAlertViewDelegate>

@property (nonatomic,strong)  MXChipPair* currentPair;
@property (nonatomic,strong)  peiDuiOutTimeCell_EN* failViewzb;
@end

@implementation JingShuiWifiViewController_EN
...
- (void)layOutWifiView
{
    ...
    //配网失败视图加载 zb
    _failViewzb=(peiDuiOutTimeCell_EN*)[[[NSBundle mainBundle] loadNibNamed:@"peiDuiOutTimeCell_EN" owner:self options:nil] lastObject];
