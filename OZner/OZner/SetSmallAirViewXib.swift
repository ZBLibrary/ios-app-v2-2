...
class SetSmallAirViewXib: UIView {
   ...
   // @IBOutlet var Attention: UILabel!
    ...
    @IBOutlet var commonQuestionLabel: UILabel!
    override func draw(_ rect: CGRect) {
        ...
        introduceLabel.text=loadLanguage("空气净化器使用说明")
         commonQuestionLabel.text=loadLanguage("常见问题")
