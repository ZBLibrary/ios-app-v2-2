...
@implementation waterReplenishChartView
...
- (void)weekGraphView:(int)beforeOrAfter
{
    ...
    waterReplenishMPGraphView* graph=[[waterReplenishMPGraphView alloc] initWithFrame: CGRectMake(14*(SCREEN_WIDTH/375.0),0, SCREEN_WIDTH-14*(SCREEN_WIDTH/375.0)*2, 180) timeType:0 IsBadTds:beforeOrAfter];
...
- (void)monthGraphView:(int)beforeOrAfter
{
    ...
    waterReplenishMPGraphView* graph=[[waterReplenishMPGraphView alloc] initWithFrame: CGRectMake(14*(SCREEN_WIDTH/375.0),0, SCREEN_WIDTH-14*(SCREEN_WIDTH/375.0)*2, 180) timeType:1 IsBadTds:beforeOrAfter];
    NSMutableArray* muArr = [[NSMutableArray alloc]init];
