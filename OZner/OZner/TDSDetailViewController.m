...
- (UITableViewCell*)createSecondCell:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CenterChartCell_EN* circleCell = [tableView dequeueReusableCellWithIdentifier:tdsSecondCell];
    circleCell = [[[NSBundle mainBundle]loadNibNamed:@"CenterChartCell_EN" owner:self options:nil] objectAtIndex:0];
