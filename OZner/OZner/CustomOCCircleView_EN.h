...
@protocol CustomOCCircleView_ENDelegate <NSObject>

- (void)seeTdsDetail;

@end

@interface CustomOCCircleView_EN : UIView
...
@property (nonatomic,assign) id<CustomOCCircleView_ENDelegate>delegate;
