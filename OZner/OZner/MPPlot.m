...
+ (id)plotWithType:(MPPlotType)type frame:(CGRect)frame timeType:(int)timeType
{
    ...
    switch (type) {
        ...
        case MPPlotTypeBars:
            return [[MPBarsGraphView alloc] initWithFrame:frame timeType:timeType];
            break;
...
- (UIColor *)graphColor{
    ...
    return _graphColor ? [UIColor colorWithRed:88.0/255.0 green:155.0/255.0 blue:254.0/255.0 alpha:1.000] : [UIColor colorWithRed:88.0/255.0 green:155.0/255.0 blue:254.0/255.0 alpha:1.000];
