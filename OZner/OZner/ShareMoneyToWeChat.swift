...
class ShareMoneyToWeChat: UIView {
    ...
    @IBAction func shareClick(_ sender: UIButton) {
        ...
        ShareManager.shareManagerInstance().shareLink(toWeChat: [WXSceneSession,WXSceneTimeline][sender.tag], link: shareStr, title: "疯了疯了，注册浩泽会员就送微信红包", titleImg: UIImage(named: "loginLogo"), linkDes: "点击即可领取浩泽大红包")
