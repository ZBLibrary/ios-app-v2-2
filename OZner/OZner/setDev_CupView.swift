...
class setDev_CupView: UIView,UITextFieldDelegate {
    ...
    func updateData()
    {
      ...
      let tmpInt=setCupStructdata["my_drinkwater"] as! String
        ...
        cup_remindspace.text=(tmptime/60==0 ? "":"\(tmptime/60)小时")+(tmptime%60==0 ? "":"\(tmptime%60)分钟")
    ...
    func loadData()
    {
        ...
        let plistPath = documentsDirectory.stringByAppendingPathComponent("SetCup.plist")
       ...
       // print(setCupStructdata)
        if setCupStructdata==nil
        {
            ...
            //读取plist文件路径
            let path=bundle.pathForResource("SetCup", ofType: "plist")
