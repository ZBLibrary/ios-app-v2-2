...
@optional
- (void)listViewOffset:(CGFloat)offset;
- (void)listViewCurrentIndex:(int)nIndex;
- (void)listViewCurrentIndexAndRect:(int)nIndex rect:(CGRect)rect view:(UIView*)view point:(CGPoint)point;
@end
...
- (void)overReloadListView:(JTListView *)listView;
@end
